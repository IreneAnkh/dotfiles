...
source $XDG_CONFIG_HOME/zsh/colors

# set up prompt
NEWLINE=$'\n'
PROMPT="${NEWLINE}%F{$COL5} $ %f%k" # minimal
#PROMPT="${NEWLINE}%K{$COL1}%F{$COL2}$(date +%_I:%M%P) %K{$COL3}%F{$COL4} %n %K{$COL5} %~ %f%k ❯ " wallust 
...
#echo -e "${NEWLINE}\x1b[38;5;137m\x1b[48;5;0m it's $(print -P '%D{%_I:%M%P}\n') \x1b[38;5;180m\x1b[48;5;0m $(uptime -p | cut -c 4-) \x1b[38;5;223m\033[0m" # current

print '\n'

source $XDG_CONFIG_HOME/zsh/pfetch
pfetch
